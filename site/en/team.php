...
<!-- Mirrored from nodc.ogs.it/about/team by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Aug 2024 07:57:51 GMT -->
<!-- Added by HTTrack -->
                      ...
                      <div class="col-12">
                        <div class="link-list-wrapper">
                          <ul class="link-list locale-list">
                            <li>
                              <a class="list-item" href="teamit.html"><span>ita</span></a>
                            </li>
                          </ul>
                          <ul class="link-list locale-list">
                            <li>
                              <a class="list-item" href="team.html"><span>eng</span></a>
                            </li>
                          </ul>
                        </div>
                      </div>
    ...
    <div class="row">
      <main class="col-12 col-sm-8 col-lg-7">
        <div class="inner-content pb-5">
          <h1 class="pt-4 mb-5">Team</h1>

          <div class="d-flex flex-column justify-content-start justify-content-md-around flex-wrap flex-sm-nowrap">
            <div class="avatar-wrapper avatar-extra-text" id="member-mrossi">
              <a class="avatar size-xl" href="https://www.ogs.it/en/users/mario-rossi">
                <img src="./images/team/" alt="Mario Rossi" />
              </a>
              <a class="arrow-link" href="https://www.ogs.it/en/users/mario-rossi">
                <svg class="icon">
                  <use
              ...
              <div class="extra-text">
                <h4>Mario Rossi</h4>
                <p>Grande capo</p>
                <p>asdrubale uno due tre</p>
                <a href="mailto:mrossi@ogs.it" title="mrossi@ogs.it">mrossi@ogs.it</a>
              </div>
            </div>
          ...
          <div class="sidebar-linklist-wrapper">
            <div class="link-list-wrapper">
              <ul class="link-list">
                ...
                <li><a class="list-item medium" href="datacentre.html"><span>The Data Centre</span></a>
                </li>
                <li><a class="list-item medium" href="mission.html"><span>Mission</span></a>
                </li>
                <li><a class="list-item medium" href="qualitypolicy.html"><span>Quality policy</span></a>
                </li>
                <li><a class="list-item medium" href="openscience.html"><span>Open Science</span></a>
                </li>
                <li><a class="list-item medium active"><span>Team</span></a>
                </li>
                <li><a class="list-item medium" href="links.html"><span>Links</span></a>
                </li>
                <li><a class="list-item medium" href="contact-us.html"><span>Contact us</span></a>
                </li>
              </ul>
            </div>
          </div>
