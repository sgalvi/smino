                      ...
                      <div class="col-12">
                        <div class="link-list-wrapper">
                          <ul class="link-list locale-list">
                            <li>
                              <a class="list-item" href="contattaci.html"><span>ita</span></a>
                            </li>
                          </ul>
                          <ul class="link-list locale-list">
                            <li>
                              <a class="list-item" href="contact-us.html"><span>eng</span></a>
                            </li>
                          </ul>
                        </div>
                      </div>
              ...
              <div class="navbar-collapsable" id="nav10">
                ...
                <div class="menu-wrapper">
                  <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" href="contact-us.html"><span> Contact us</span></a>
                    </li>
                ...
                <a href="mailto:smino@ogs.it" targhet="_blank">
                  <div class="it-right-zone">
                    ...
                    <span>
                      <svg class="icon">
                        <use
                          href="./wicket/resource/de.agilecoders.wicket.webjars.request.resource.IWebjarsResourceReference/webjars/bootstrap-italia/current/svg/sprite.svg#it-external-link">
                        </use>
                      </svg>
                    </span>
                  </div>
...
<!-- Mirrored from nodc.ogs.it/about/contact-us by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Aug 2024 08:10:16 GMT -->
