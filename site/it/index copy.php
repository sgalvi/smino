...
<div class="home-second-row__wrapper">
                ...
                <div class="row bs-2col node node--type-news node--view-mode-card2col">
                  ...
                  <div class="col-sm-6 bs-region bs-region--right">
                    ...
                    <div class="field field--name-node-title">
                      <h3>
                        <a href="../../activities/news/Festival_dellacqua_against_plastic_pollution.html">La rete Sismometrica</a>
                      </h3>
                    </div>
                    ...
                    <div class="field field--name-node-link field--type-ds field--label-hidden field__item">
                      <a href="./sismo.php" class="bqicon bqicon-inline read-more bq-processed">read more<svg class="icon">
              ...
              <div class="card-wrapper card-space">
                <div class="row bs-2col node node--type-news node--view-mode-card2col">
                  ...
                  <div class="col-sm-6 bs-region bs-region--right">
                    ...
                    <div class="field field--name-node-title">
                      <h3>
                        <a href="./frednet.php">La rete Geodetica</a>
                      </h3>
                    </div>
                    ...
                    <div class="field field--name-node-link field--type-ds field--label-hidden field__item">
                      <a href="./frednet.php" class="bqicon bqicon-inline read-more bq-processed">read more<svg class="icon">
                          <use href="../../wicket/resource/de.agilecoders.wicket.webjars.request.resource.IWebjarsResourceReference/webjars/bootstrap-italia/current/svg/sprite.svg#it-arrow-right-circle"></use></svg
                      ></a>
                    </div>
                  </div>
              ...
              <div class="card-wrapper card-space">
                <div class="row bs-2col node node--type-news node--view-mode-card2col">
                  ...
                  <div class="col-sm-6 bs-region bs-region--right">
                    ...
                    <div class="field field--name-node-title">
                      <h3>
                        <a href="../../activities/news/Festival_dellacqua_against_plastic_pollution.html">La rete Fibra</a>
                      </h3>
                    </div>
              ...
              <div class="card-wrapper card-space">
                <div class="row bs-2col node node--type-news node--view-mode-card2col">
                  ...
                  <div class="col-sm-6 bs-region bs-region--right">
                    ...
                    <div class="field field--name-node-title">
                      <h3>
                        <a href="../../activities/news/Festival_dellacqua_against_plastic_pollution.html">La rete Gravimetrica</a>
                      </h3>
                    </div>
              ...
              <div class="card-wrapper card-space">
                <div class="row bs-2col node node--type-news node--view-mode-card2col">
                  ...
                  <div class="col-sm-6 bs-region bs-region--right">
                    ...
                    <div class="field field--name-node-title">
                      <h3>
                        <a href="./strongmotion.php">La rete Acceletrometrica</a>
                      </h3>
                    </div>

                    <div class="clearfix text-formatted field field--name-body">
                      <p>Sono stati installati sensori accelerometrici di alta qualità in 29 stazioni della rete sismometrica, e oltre 100 sensori a medio costo attraverso progetti specifici. I dati raccolti in tempo reale permettono di stimare rapidamente l'impatto dei terremoti. </p>
                    </div>

                    <div class="field field--name-node-link field--type-ds field--label-hidden field__item">
                      <a href="./strongmotion.php" class="bqicon bqicon-inline read-more bq-processed">read more<svg class="icon">
                          <use href="../../wicket/resource/de.agilecoders.wicket.webjars.request.resource.IWebjarsResourceReference/webjars/bootstrap-italia/current/svg/sprite.svg#it-arrow-right-circle"></use></svg
                      ></a>
                    </div>
                  </div>
      ...
      <div class="more-link">
        <a  href="" class="bqicon btn btn-primary btn-sm bq-processed">Vedi tutte le reti<svg class="icon">
            <use href="../../wicket/resource/de.agilecoders.wicket.webjars.request.resource.IWebjarsResourceReference/webjars/bootstrap-italia/current/svg/sprite.svg#it-arrow-right-circle"></use></svg
        ></a>
      </div>
      ...
      <!-- end row-->
       <div class="home-third-row__wrapper">
        <div class="container">
                ...
                <div class="card-wrapper card-space">
                  <div class="card card-bg">
                    <div>
                      <div class="card-body">
                        <h3 class="card-title">
                          <a href="" hreflang="it">Progetto 1</a>
                        </h3>
                        <p class="card-text">
                ...
                <div class="card-wrapper card-space">
                  <div class="card card-bg">
                    <div>
                      <div class="card-body">
                        <h3 class="card-title">
                          <a href="" hreflang="it">Progetto 2</a>
                        </h3>
                        <p class="card-text">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.                         </p>
          ...
          <div class="more-link">
            <a href="activities/projects.html" class="bqicon btn btn-primary btn-sm bq-processed">View all projects<svg class="icon">
                <use href="wicket/resource/de.agilecoders.wicket.webjars.request.resource.IWebjarsResourceReference/webjars/bootstrap-italia/current/svg/sprite.svg#it-arrow-right-circle"></use>
              </svg>
            </a>
          </div>
